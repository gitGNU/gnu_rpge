...
(init-tilegrid 50 40)
(set-all-tiles (create-tile "/usr/local/share/RPGE/images/tile2.png" (make-rect 0 0 16 16) block-none))
(set-mob-bootstrap-proc! (lambda (X) 
			   (set-mob-data X (init-table)) 
			   (stats-init X)
                           (init-mob-bindings X)))
(define m (make-mob 0 0 "/usr/local/share/RPGE/images/sprite_letter.png"))
...
(set-tile 5 5 (create-tile "/usr/local/share/RPGE/images/tile1.png" (make-rect 0 0 16 16) block-all-undirectional))
(define n (make-mob 5 0 "/usr/local/share/RPGE/images/sprite_letter.png"))
(make-thread safe-load "/usr/local/share/RPGE/scm/keys.scm")
(make-thread safe-load "/usr/local/share/RPGE/scm/mob_event_test.scm")